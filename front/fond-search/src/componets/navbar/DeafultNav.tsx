...
function DefaultNav1() {
  return(
    <Disclosure as="nav" className="flex bg-gray-900 h-16 items-center">
      <div className="px-6">
      ...
      <DisclosurePanel className="bg-blue-800">
        hej
       <DisclosureButton className="bg-red-800">
          då
       </DisclosureButton>
      </DisclosurePanel>
      </div>
